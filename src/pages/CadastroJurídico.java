 ...
 * @author victo
 */
public class CadastroJurídico extends javax.swing.JFrame {

    /**
     * Creates new form PrincipalTela
     */
    public CadastroJurídico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPasswordField1.setText("ffffff");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bradesco", "Santander" }));
        ...
        jPanel3.setBackground(new java.awt.Color(34, 180, 167));

        jLabel2.setBackground(new java.awt.Color(23, 159, 211));
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/money-transfer.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroJurídico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroJurídico().setVisible(true);
            }
        });
    }
