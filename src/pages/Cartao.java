...
public class Cartao extends JFrame {
        ...
        telaTotalLayout.setHorizontalGroup(
            ...
            .addGroup(telaTotalLayout.createSequentialGroup()
                ...
                .addGroup(telaTotalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(TituloInfoCartao, GroupLayout.PREFERRED_SIZE, 360, GroupLayout.PREFERRED_SIZE)
                    .addGroup(telaTotalLayout.createSequentialGroup()
                        .addComponent(voltar)
                        .addGap(18, 18, 18)
                        .addComponent(tituloCartao, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(262, Short.MAX_VALUE))
            .addGroup(telaTotalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(GroupLayout.Alignment.TRAILING, telaTotalLayout.createSequentialGroup()
                    .addContainerGap(19, Short.MAX_VALUE)
                    .addComponent(cartaoInfo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        ...
        telaTotalLayout.setVerticalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, telaTotalLayout.createSequentialGroup()
                ...
                .addGroup(telaTotalLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tituloCartao, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(TituloInfoCartao, GroupLayout.PREFERRED_SIZE, 47, GroupLayout.PREFERRED_SIZE)
    ...
    private JLabel TituloInfoCartao;
    private JPanel telaTotal;
    private JPanel tituloCartao;
